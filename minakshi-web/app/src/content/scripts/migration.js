...
const PAYLOAD_API = "http://localhost:3002/api/podcasts";
const PAYLOAD_TOKEN = process.env.PAYLOAD_API_KEY;

if (!PAYLOAD_TOKEN) {
  throw new Error(
    "PAYLOAD_API_KEY environment variable is required. Run with `node --env-file=.env migration.js` or export it in your shell."
  );
}
